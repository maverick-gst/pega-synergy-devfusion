...
export const CATEGORIZATION_HUMAN_TEMPLATE = `The previous conversation is an interaction between a customer support representative and a user.
Extract whether the representative is routing the user to a billing or technical team, or whether they are just responding conversationally.
Respond with a JSON object containing a single key called "nextRepresentative" with one of the following values:

If they want to route the user to the billing team, respond with: {"nextRepresentative": "BILLING"}
If they want to route the user to the technical team, respond with: {"nextRepresentative": "TECHNICAL"}
Otherwise, respond with: {"nextRepresentative": "RESPOND"}
